# Release Notes Workflow Specification

## Purpose

Define the maintainer workflow for generating user-facing release notes with a constrained local Pi process, reviewing the exact draft, and replacing an existing GitHub release body without committing generated notes or adding model credentials to CI.
